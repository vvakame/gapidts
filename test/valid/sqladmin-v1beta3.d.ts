    ...
    module sqladmin {
        var backupRuns: {
            ...
            get: (params: {
                ...
                instance: string;
                project: string;
            }) => { execute(callback: (data: IBackupRun, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                project: string;
            }) => { execute(callback: (data: IBackupRunsListResponse, original: string) => void):void; };
        };
        var flags: {
            /**
             ...
             */
            list: (params: {
            }) => { execute(callback: (data: IFlagsListResponse, original: string) => void):void; };
        };
        var instances: {
            /**
            ...
            }) => { execute(callback: (data: IInstancesCloneResponse, original: string) => void):void; };
            /**
            ...
            delete: (params: {
                instance: string;
                project: string;
            }) => { execute(callback: (data: IInstancesDeleteResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IInstancesExportResponse, original: string) => void):void; };
            /**
            ...
            get: (params: {
                instance: string;
                project: string;
            }) => { execute(callback: (data: IDatabaseInstance, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IInstancesImportResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IInstancesInsertResponse, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                project: string;
            }) => { execute(callback: (data: IInstancesListResponse, original: string) => void):void; };
            /**
            ...
            patch: (params: {
                ...
                project: string;
                resource?: IDatabaseInstance;
            }) => { execute(callback: (data: IInstancesUpdateResponse, original: string) => void):void; };
            /**
            ...
            promoteReplica: (params: {
                instance: string;
                project: string;
            }) => { execute(callback: (data: IInstancesPromoteReplicaResponse, original: string) => void):void; };
            /**
            ...
            resetSslConfig: (params: {
                instance: string;
                project: string;
            }) => { execute(callback: (data: IInstancesResetSslConfigResponse, original: string) => void):void; };
            /**
            ...
            restart: (params: {
                instance: string;
                project: string;
            }) => { execute(callback: (data: IInstancesRestartResponse, original: string) => void):void; };
            /**
            ...
            restoreBackup: (params: {
                ...
                instance: string;
                project: string;
            }) => { execute(callback: (data: IInstancesRestoreBackupResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IInstancesSetRootPasswordResponse, original: string) => void):void; };
            /**
        ...
        var operations: {
            ...
            get: (params: {
                ...
                operation: string;
                project: string;
            }) => { execute(callback: (data: IInstanceOperation, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                project: string;
            }) => { execute(callback: (data: IOperationsListResponse, original: string) => void):void; };
        };
        var sslCerts: {
            /**
            ...
            }) => { execute(callback: (data: ISslCertsDeleteResponse, original: string) => void):void; };
            /**
            ...
            get: (params: {
                ...
                project: string;
                sha1Fingerprint: string;
            }) => { execute(callback: (data: ISslCert, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: ISslCertsInsertResponse, original: string) => void):void; };
            /**
            ...
            list: (params: {
                instance: string;
                project: string;
            }) => { execute(callback: (data: ISslCertsListResponse, original: string) => void):void; };
        };
        var tiers: {
            /**
            ...
            list: (params: {
                project: string;
            }) => { execute(callback: (data: ITiersListResponse, original: string) => void):void; };
        };
        /**
