    ...
    module gan {
        var advertisers: {
            ...
            get: (params: {
                ...
                role: string;
                roleId: string;
            }) => { execute(callback: (data: IAdvertiser, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                role: string;
                roleId: string;
            }) => { execute(callback: (data: IAdvertisers, original: string) => void):void; };
        };
        var ccOffers: {
            /**
            ...
            list: (params: {
                ...
                projection?: string;
                publisher: string;
            }) => { execute(callback: (data: ICcOffers, original: string) => void):void; };
        };
        var events: {
            /**
        ...
        var links: {
            ...
            get: (params: {
                ...
                role: string;
                roleId: string;
            }) => { execute(callback: (data: ILink, original: string) => void):void; };
            /**
             * Inserts a new link.
             * @params {string} role The role of the requester. Valid values: 'advertisers' or 'publishers'.
             * @params {string} roleId The ID of the requesting advertiser or publisher.
            ...
            list: (params: {
                ...
                startDateMax?: string;
                startDateMin?: string;
            }) => { execute(callback: (data: ILinks, original: string) => void):void; };
        };
        var publishers: {
            /**
            ...
            get: (params: {
                ...
                role: string;
                roleId: string;
            }) => { execute(callback: (data: IPublisher, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                role: string;
                roleId: string;
            }) => { execute(callback: (data: IPublishers, original: string) => void):void; };
        };
        var reports: {
            /**
