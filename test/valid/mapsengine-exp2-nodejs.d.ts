...
declare module googleapis.mapsengine {
    var assets: {
        ...
        permissions: {
            ...
            list: (params: {
                id: string;
            }, callback: (err: any, response: IPermissionsListResponse) => void) => void;
        };
    };
    var layers: {
        /**
        ...
        permissions: {
            ...
            }, callback: (err: any, response: IPermissionsBatchInsertResponse) => void) => void;
            /**
             * Return all of the permissions for the specified asset.
             * @params {string} id The ID of the asset whose permissions will be listed.
             */
    ...
    var permissionIds: {
        ...
        getIdForEmail: (params: {
            email: string;
        }, callback: (err: any, response: IPermissionsGetIdForEmailResponse) => void) => void;
    };
    var projects: {
        /**
