    ...
    module androidpublisher {
        var edits: {
            ...
            commit: (params: {
                editId: string;
                packageName: string;
            }) => { execute(callback: (data: IAppEdit, original: string) => void):void; };
            /**
            ...
            apklistings: {
                ...
                get: (params: {
                    ...
                    language: string;
                    packageName: string;
                }) => { execute(callback: (data: IApkListing, original: string) => void):void; };
                /**
                ...
                list: (params: {
                    ...
                    editId: string;
                    packageName: string;
                }) => { execute(callback: (data: IApkListingsListResponse, original: string) => void):void; };
                /**
            ...
            apks: {
                ...
                list: (params: {
                    editId: string;
                    packageName: string;
                }) => { execute(callback: (data: IApksListResponse, original: string) => void):void; };
                /**
                 * 
                 * @params {string} editId Unique identifier for this edit.
                 * @params {string} packageName Unique identifier for the Android app that is being updated; for example, "com.spiffygame".
                ...
                upload: (params: {
                    editId: string;
                    packageName: string;
                }) => { execute(callback: (data: IApk, original: string) => void):void; };
            };
            details: {
                /**
                ...
                get: (params: {
                    editId: string;
                    packageName: string;
                }) => { execute(callback: (data: IAppDetails, original: string) => void):void; };
                /**
            ...
            expansionfiles: {
                ...
                get: (params: {
                    ...
                    packageName: string;
                }) => { execute(callback: (data: IExpansionFile, original: string) => void):void; };
                /**
                ...
                upload: (params: {
                    ...
                    expansionFileType: string;
                    packageName: string;
                }) => { execute(callback: (data: IExpansionFilesUploadResponse, original: string) => void):void; };
            };
            images: {
                /**
                ...
                deleteall: (params: {
                    ...
                    language: string;
                    packageName: string;
                }) => { execute(callback: (data: IImagesDeleteAllResponse, original: string) => void):void; };
                /**
                ...
                list: (params: {
                    ...
                    language: string;
                    packageName: string;
                }) => { execute(callback: (data: IImagesListResponse, original: string) => void):void; };
                /**
                ...
                upload: (params: {
                    ...
                    language: string;
                    packageName: string;
                }) => { execute(callback: (data: IImagesUploadResponse, original: string) => void):void; };
            };
            listings: {
                /**
                ...
                get: (params: {
                    ...
                    language: string;
                    packageName: string;
                }) => { execute(callback: (data: IListing, original: string) => void):void; };
                /**
            ...
            testers: {
                ...
                get: (params: {
                    ...
                    packageName: string;
                    track: string;
                }) => { execute(callback: (data: ITesters, original: string) => void):void; };
                /**
                 * 
                 * @params {string} editId Unique identifier for this edit.
                 * @params {string} packageName Unique identifier for the Android app that is being updated; for example, "com.spiffygame".
            ...
            tracks: {
                ...
                get: (params: {
                    ...
                    packageName: string;
                    track: string;
                }) => { execute(callback: (data: ITrack, original: string) => void):void; };
                /**
                ...
                list: (params: {
                    editId: string;
                    packageName: string;
                }) => { execute(callback: (data: ITracksListResponse, original: string) => void):void; };
                /**
        ...
        var inappproducts: {
            ...
            }) => { execute(callback: (data: IInappproductsBatchResponse, original: string) => void):void; };
            /**
            ...
            get: (params: {
                packageName: string;
                sku: string;
            }) => { execute(callback: (data: IInAppProduct, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                startIndex?: number;
                token?: string;
            }) => { execute(callback: (data: IInappproductsListResponse, original: string) => void):void; };
            /**
        ...
        var purchases: {
            products: {
                ...
                get: (params: {
                    ...
                    productId: string;
                    token: string;
                }) => { execute(callback: (data: IProductPurchase, original: string) => void):void; };
            };
            subscriptions: {
                /**
                ...
                get: (params: {
                    ...
                    subscriptionId: string;
                    token: string;
                }) => { execute(callback: (data: ISubscriptionPurchase, original: string) => void):void; };
            };
        };
        interface IApk {
            /**
