        ...
        var reports: {
            ...
            compatibleFields: {
                ...
                query: (params: {
                    ...
                    execute(callback: (data: IResponse<ICompatibleFields>, original: string) => void):void;
                    then<U>(onFulfilled: (response: IPromiseResponse<ICompatibleFields>) =>  Thenable<U>, onRejected?:(reason:IPromiseErrorResponse) => Thenable<U>): Thenable<U>;
                    then<U>(onFulfilled: (response: IPromiseResponse<ICompatibleFields>) =>  Thenable<U>, onRejected?:(reason:IPromiseErrorResponse) => U): Thenable<U>;
                    then<U>(onFulfilled: (response: IPromiseResponse<ICompatibleFields>) =>  Thenable<U>, onRejected?:(reason:IPromiseErrorResponse) => void): Thenable<U>;
                    then<U>(onFulfilled: (response: IPromiseResponse<ICompatibleFields>) =>  U, onRejected?:(reason:IPromiseErrorResponse) => Thenable<U>): Thenable<U>;
                    then<U>(onFulfilled: (response: IPromiseResponse<ICompatibleFields>) =>  U, onRejected?:(reason:IPromiseErrorResponse) => U): Thenable<U>;
                    then<U>(onFulfilled: (response: IPromiseResponse<ICompatibleFields>) =>  U, onRejected?:(reason:IPromiseErrorResponse) => void): Thenable<U>;
                };
            };
            files: {
                /**
