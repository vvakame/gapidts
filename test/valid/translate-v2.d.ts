...
declare module gapi.client {
    ...
    module translate {
        var detections: {
            ...
            list: (params: {
                q: string;
            }) => { execute(callback: (data: IDetectionsListResponse, original: string) => void):void; };
        };
        var languages: {
            /**
            ...
            list: (params: {
                target?: string;
            }) => { execute(callback: (data: ILanguagesListResponse, original: string) => void):void; };
        };
        var translations: {
            /**
            ...
            list: (params: {
                ...
                source?: string;
                target: string;
            }) => { execute(callback: (data: ITranslationsListResponse, original: string) => void):void; };
        };
