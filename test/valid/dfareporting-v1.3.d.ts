...
declare module gapi.client {
    ...
    module dfareporting {
        var dimensionValues: {
            ...
            }) => { execute(callback: (data: IDimensionValueList, original: string) => void):void; };
        };
        var files: {
            /**
        ...
        var reports: {
            ...
            list: (params: {
                ...
                sortField?: string;
                sortOrder?: string;
            }) => { execute(callback: (data: IReportList, original: string) => void):void; };
            /**
            ...
            compatibleFields: {
                ...
                query: (params: {
                    profileId: string;
                    resource?: IReport;
                }) => { execute(callback: (data: ICompatibleFields, original: string) => void):void; };
            };
            files: {
                /**
        ...
        var userProfiles: {
            ...
            get: (params: {
                profileId: string;
            }) => { execute(callback: (data: IUserProfile, original: string) => void):void; };
            /**
             * Retrieves list of user profiles for a user.
             */
            list: (params: {
            }) => { execute(callback: (data: IUserProfileList, original: string) => void):void; };
        };
        /**
