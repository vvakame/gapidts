...
declare module gapi.client {
    ...
    module cloudmonitoring {
        var metricDescriptors: {
            ...
            }) => { execute(callback: (data: IListMetricDescriptorsResponse, original: string) => void):void; };
        };
        var timeseries: {
            /**
...
If neither oldest nor timespan is specified, the default time interval will be (youngest - 4 hours, youngest].
            ...
            }) => { execute(callback: (data: IListTimeseriesResponse, original: string) => void):void; };
        };
...
If neither oldest nor timespan is specified, the default time interval will be (youngest - 4 hours, youngest].
            ...
            }) => { execute(callback: (data: IListTimeseriesDescriptorsResponse, original: string) => void):void; };
        };
        /**
