    ...
    module games {
        var achievementDefinitions: {
            ...
            list: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: IAchievementDefinitionsListResponse, original: string) => void):void; };
        };
        var achievements: {
            /**
            ...
            }) => { execute(callback: (data: IAchievementIncrementResponse, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                playerId: string;
                state?: string;
            }) => { execute(callback: (data: IPlayerAchievementListResponse, original: string) => void):void; };
            /**
            ...
            reveal: (params: {
                achievementId: string;
            }) => { execute(callback: (data: IAchievementRevealResponse, original: string) => void):void; };
            /**
            ...
            setStepsAtLeast: (params: {
                achievementId: string;
                steps: number;
            }) => { execute(callback: (data: IAchievementSetStepsAtLeastResponse, original: string) => void):void; };
            /**
            ...
            unlock: (params: {
                achievementId: string;
            }) => { execute(callback: (data: IAchievementUnlockResponse, original: string) => void):void; };
            /**
             * Updates multiple achievements for the currently authenticated player.
             */
            updateMultiple: (params: {
                resource?: IAchievementUpdateMultipleRequest;
            }) => { execute(callback: (data: IAchievementUpdateMultipleResponse, original: string) => void):void; };
        };
        var applications: {
            /**
            ...
            get: (params: {
                ...
                language?: string;
                platformType?: string;
            }) => { execute(callback: (data: IApplication, original: string) => void):void; };
            /**
        ...
        var events: {
            ...
            listByPlayer: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: IPlayerEventListResponse, original: string) => void):void; };
            /**
            ...
            listDefinitions: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: IEventDefinitionListResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IEventUpdateResponse, original: string) => void):void; };
        };
        var leaderboards: {
            /**
            ...
            }) => { execute(callback: (data: ILeaderboard, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: ILeaderboardListResponse, original: string) => void):void; };
        };
        var metagame: {
            /**
            ...
            }) => { execute(callback: (data: IMetagameConfig, original: string) => void):void; };
            /**
            ...
            listCategoriesByPlayer: (params: {
                ...
                pageToken?: string;
                playerId: string;
            }) => { execute(callback: (data: ICategoryListResponse, original: string) => void):void; };
        };
        var players: {
            /**
            ...
            get: (params: {
                language?: string;
                playerId: string;
            }) => { execute(callback: (data: IPlayer, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: IPlayerListResponse, original: string) => void):void; };
        };
        var pushtokens: {
            /**
        ...
        var quests: {
            ...
            accept: (params: {
                language?: string;
                questId: string;
            }) => { execute(callback: (data: IQuest, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                playerId: string;
            }) => { execute(callback: (data: IQuestListResponse, original: string) => void):void; };
        };
        var revisions: {
            /**
...
- "WEB_APP" - Client is running as a Web App.
            ...
            }) => { execute(callback: (data: IRevisionCheckResponse, original: string) => void):void; };
        };
        var rooms: {
            /**
            ...
            }) => { execute(callback: (data: IRoom, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: IRoomList, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IRoomStatus, original: string) => void):void; };
        };
        var scores: {
            /**
            ...
            get: (params: {
                ...
                playerId: string;
                timeSpan: string;
            }) => { execute(callback: (data: IPlayerLeaderboardScoreListResponse, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                timeSpan: string;
            }) => { execute(callback: (data: ILeaderboardScores, original: string) => void):void; };
            /**
            ...
            submit: (params: {
                ...
                score: string;
                scoreTag?: string;
            }) => { execute(callback: (data: IPlayerScoreResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IPlayerScoreListResponse, original: string) => void):void; };
        };
        var snapshots: {
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                playerId: string;
            }) => { execute(callback: (data: ISnapshotListResponse, original: string) => void):void; };
        };
        var turnBasedMatches: {
            ...
            }) => { execute(callback: (data: ITurnBasedMatch, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: ITurnBasedMatchList, original: string) => void):void; };
            /**
            ...
            rematch: (params: {
                ...
                matchId: string;
                requestId?: string;
            }) => { execute(callback: (data: ITurnBasedMatchRematch, original: string) => void):void; };
            /**
            ...
            sync: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: ITurnBasedMatchSync, original: string) => void):void; };
            /**
