    ...
    module dns {
        var changes: {
            ...
            list: (params: {
                ...
                sortBy?: string;
                sortOrder?: string;
            }) => { execute(callback: (data: IChangesListResponse, original: string) => void):void; };
        };
        var managedZones: {
            /**
            ...
            }) => { execute(callback: (data: IManagedZone, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                project: string;
            }) => { execute(callback: (data: IManagedZonesListResponse, original: string) => void):void; };
        };
        var projects: {
            /**
        ...
        var resourceRecordSets: {
            ...
            list: (params: {
                ...
                project: string;
                type?: string;
            }) => { execute(callback: (data: IResourceRecordSetsListResponse, original: string) => void):void; };
        };
        /**
