...
declare module gapi.client {
    ...
    module adexchangebuyer {
        var accounts: {
             ...
             */
            list: (params: {
            }) => { execute(callback: (data: IAccountsList, original: string) => void):void; };
            /**
        ...
        var billingInfo: {
            ...
            get: (params: {
                accountId: number;
            }) => { execute(callback: (data: IBillingInfo, original: string) => void):void; };
            /**
             * Retrieves a list of billing information for all accounts of the authenticated user.
             */
            list: (params: {
            }) => { execute(callback: (data: IBillingInfoList, original: string) => void):void; };
        };
        var creatives: {
            /**
            ...
            }) => { execute(callback: (data: ICreative, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                statusFilter?: string;
            }) => { execute(callback: (data: ICreativesList, original: string) => void):void; };
        };
        var directDeals: {
            /**
            ...
            get: (params: {
                id: string;
            }) => { execute(callback: (data: IDirectDeal, original: string) => void):void; };
            /**
             * Retrieves the authenticated user's list of direct deals.
             */
            list: (params: {
            }) => { execute(callback: (data: IDirectDealsList, original: string) => void):void; };
        };
        var performanceReport: {
            ...
            }) => { execute(callback: (data: IPerformanceReportList, original: string) => void):void; };
        };
        var pretargetingConfig: {
            ...
            get: (params: {
                accountId: string;
                configId: string;
            }) => { execute(callback: (data: IPretargetingConfig, original: string) => void):void; };
            /**
            ...
            list: (params: {
                accountId: string;
            }) => { execute(callback: (data: IPretargetingConfigList, original: string) => void):void; };
            /**
