    ...
    module plusDomains {
        ...
        var audiences: {
            ...
            list: (params: {
                ...
                pageToken?: string;
                userId: string;
            }) => { execute(callback: (data: IAudiencesFeed, original: string) => void):void; };
        };
        var circles: {
            /**
            ...
            addPeople: (params: {
                ...
                email?: string;
                userId?: string;
            }) => { execute(callback: (data: ICircle, original: string) => void):void; };
            /**
             * Get a circle.
            ...
            list: (params: {
                ...
                pageToken?: string;
                userId: string;
            }) => { execute(callback: (data: ICircleFeed, original: string) => void):void; };
            /**
        ...
        var media: {
            ...
            insert: (params: {
                ...
                userId: string;
                resource?: IMedia;
            }) => { execute(callback: (data: IMedia, original: string) => void):void; };
        };
        var people: {
            /**
