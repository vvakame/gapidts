...
declare module gapi.client {
    ...
    module identitytoolkit {
        var relyingparty: {
            ...
            }) => { execute(callback: (data: ICreateAuthUriResponse, original: string) => void):void; };
            /**
             * Delete user account.
             */
            deleteAccount: (params: {
                resource?: IIdentitytoolkitRelyingpartyDeleteAccountRequest;
            }) => { execute(callback: (data: IDeleteAccountResponse, original: string) => void):void; };
            /**
             * Batch download user accounts.
             */
            downloadAccount: (params: {
                resource?: IIdentitytoolkitRelyingpartyDownloadAccountRequest;
            }) => { execute(callback: (data: IDownloadAccountResponse, original: string) => void):void; };
            /**
             * Returns the account info.
             */
            getAccountInfo: (params: {
                resource?: IIdentitytoolkitRelyingpartyGetAccountInfoRequest;
            }) => { execute(callback: (data: IGetAccountInfoResponse, original: string) => void):void; };
            /**
             * Get a code for user action confirmation.
             */
            getOobConfirmationCode: (params: {
                resource?: IRelyingparty;
            }) => { execute(callback: (data: IGetOobConfirmationCodeResponse, original: string) => void):void; };
            /**
             * Get token signing public key.
             */
            getPublicKeys: (params: {
            }) => { execute(callback: (data: IIdentitytoolkitRelyingpartyGetPublicKeysResponse, original: string) => void):void; };
            /**
             * Set account info for a user.
             */
            resetPassword: (params: {
                resource?: IIdentitytoolkitRelyingpartyResetPasswordRequest;
            }) => { execute(callback: (data: IResetPasswordResponse, original: string) => void):void; };
            /**
             * Set account info for a user.
             */
            setAccountInfo: (params: {
                resource?: IIdentitytoolkitRelyingpartySetAccountInfoRequest;
            }) => { execute(callback: (data: ISetAccountInfoResponse, original: string) => void):void; };
            /**
             * Batch upload existing user accounts.
             */
            uploadAccount: (params: {
                resource?: IIdentitytoolkitRelyingpartyUploadAccountRequest;
            }) => { execute(callback: (data: IUploadAccountResponse, original: string) => void):void; };
            /**
             * Verifies the assertion returned by the IdP.
             */
            verifyAssertion: (params: {
                resource?: IIdentitytoolkitRelyingpartyVerifyAssertionRequest;
            }) => { execute(callback: (data: IVerifyAssertionResponse, original: string) => void):void; };
            /**
             * Verifies the user entered password.
             */
            verifyPassword: (params: {
                resource?: IIdentitytoolkitRelyingpartyVerifyPasswordRequest;
            }) => { execute(callback: (data: IVerifyPasswordResponse, original: string) => void):void; };
        };
        /**
