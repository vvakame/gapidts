...
declare module gapi.client {
    ...
    module drive {
        var about: {
            ...
            }) => { execute(callback: (data: IAbout, original: string) => void):void; };
        };
        var apps: {
            /**
             * Gets a specific app.
            ...
            get: (params: {
                appId: string;
            }) => { execute(callback: (data: IApp, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                languageCode?: string;
            }) => { execute(callback: (data: IAppList, original: string) => void):void; };
        };
        var changes: {
            /**
            ...
            get: (params: {
                changeId: string;
            }) => { execute(callback: (data: IChange, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                startChangeId?: string;
            }) => { execute(callback: (data: IChangeList, original: string) => void):void; };
            /**
        ...
        var children: {
            ...
            get: (params: {
                childId: string;
                folderId: string;
            }) => { execute(callback: (data: IChildReference, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                q?: string;
            }) => { execute(callback: (data: IChildList, original: string) => void):void; };
        };
        var comments: {
            /**
             * Deletes a comment.
        ...
        var files: {
            ...
            copy: (params: {
                ...
                visibility?: string;
                resource?: IFile;
            }) => { execute(callback: (data: IFile, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                projection?: string;
                q?: string;
            }) => { execute(callback: (data: IFileList, original: string) => void):void; };
            /**
        ...
        var parents: {
            ...
            get: (params: {
                fileId: string;
                parentId: string;
            }) => { execute(callback: (data: IParentReference, original: string) => void):void; };
            /**
            ...
            list: (params: {
                fileId: string;
            }) => { execute(callback: (data: IParentList, original: string) => void):void; };
        };
        var permissions: {
            /**
            ...
            get: (params: {
                fileId: string;
                permissionId: string;
            }) => { execute(callback: (data: IPermission, original: string) => void):void; };
            /**
            ...
            getIdForEmail: (params: {
                email: string;
            }) => { execute(callback: (data: IPermissionId, original: string) => void):void; };
            /**
            ...
            list: (params: {
                fileId: string;
            }) => { execute(callback: (data: IPermissionList, original: string) => void):void; };
            /**
        ...
        var properties: {
            ...
            get: (params: {
                ...
                propertyKey: string;
                visibility?: string;
            }) => { execute(callback: (data: IProperty, original: string) => void):void; };
            /**
            ...
            list: (params: {
                fileId: string;
            }) => { execute(callback: (data: IPropertyList, original: string) => void):void; };
            /**
        ...
        var replies: {
            ...
            get: (params: {
                ...
                includeDeleted?: boolean;
                replyId: string;
            }) => { execute(callback: (data: ICommentReply, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: ICommentReplyList, original: string) => void):void; };
            /**
        ...
        var revisions: {
            ...
            get: (params: {
                fileId: string;
                revisionId: string;
            }) => { execute(callback: (data: IRevision, original: string) => void):void; };
            /**
            ...
            list: (params: {
                fileId: string;
            }) => { execute(callback: (data: IRevisionList, original: string) => void):void; };
            /**
