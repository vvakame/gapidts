    ...
    module books {
        var bookshelves: {
            ...
            get: (params: {
                ...
                source?: string;
                userId: string;
            }) => { execute(callback: (data: IBookshelf, original: string) => void):void; };
            /**
            ...
            list: (params: {
                source?: string;
                userId: string;
            }) => { execute(callback: (data: IBookshelves, original: string) => void):void; };
            volumes: {
                /**
                ...
                list: (params: {
                    ...
                    startIndex?: number;
                    userId: string;
                }) => { execute(callback: (data: IVolumes, original: string) => void):void; };
            };
        };
        var cloudloading: {
            /**
            ...
            }) => { execute(callback: (data: IBooksCloudloadingResource, original: string) => void):void; };
            /**
        ...
        var layers: {
            ...
            get: (params: {
                ...
                summaryId: string;
                volumeId: string;
            }) => { execute(callback: (data: ILayersummary, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                source?: string;
                volumeId: string;
            }) => { execute(callback: (data: ILayersummaries, original: string) => void):void; };
            annotationData: {
                /**
                ...
                get: (params: {
                    ...
                    volumeId: string;
                    w?: number;
                }) => { execute(callback: (data: IAnnotationdata, original: string) => void):void; };
                /**
                ...
                list: (params: {
                    ...
                    volumeId: string;
                    w?: number;
                }) => { execute(callback: (data: IAnnotationsdata, original: string) => void):void; };
            };
            volumeAnnotations: {
                /**
                ...
                get: (params: {
                    ...
                    source?: string;
                    volumeId: string;
                }) => { execute(callback: (data: IVolumeannotation, original: string) => void):void; };
                /**
                ...
                list: (params: {
                    ...
                    volumeId: string;
                }) => { execute(callback: (data: IVolumeannotations, original: string) => void):void; };
            };
        };
        var myconfig: {
            /**
            ...
            releaseDownloadAccess: (params: {
                ...
                source?: string;
                volumeIds: string;
            }) => { execute(callback: (data: IDownloadAccesses, original: string) => void):void; };
            /**
            ...
            requestAccess: (params: {
                ...
                source: string;
                volumeId: string;
            }) => { execute(callback: (data: IRequestAccess, original: string) => void):void; };
            /**
        ...
        var mylibrary: {
            annotations: {
                ...
                get: (params: {
                    annotationId: string;
                    source?: string;
                }) => { execute(callback: (data: IAnnotation, original: string) => void):void; };
                /**
                ...
                list: (params: {
                    ...
                    updatedMin?: string;
                    volumeId?: string;
                }) => { execute(callback: (data: IAnnotations, original: string) => void):void; };
                /**
                ...
                summary: (params: {
                    layerIds: string;
                    volumeId: string;
                }) => { execute(callback: (data: IAnnotationsSummary, original: string) => void):void; };
                /**
            ...
            readingpositions: {
                ...
                get: (params: {
                    ...
                    source?: string;
                    volumeId: string;
                }) => { execute(callback: (data: IReadingPosition, original: string) => void):void; };
                /**
        ...
        var promooffer: {
            ...
            get: (params: {
                ...
                product?: string;
                serial?: string;
            }) => { execute(callback: (data: IOffers, original: string) => void):void; };
        };
        var volumes: {
            /**
            ...
            get: (params: {
                ...
                source?: string;
                volumeId: string;
            }) => { execute(callback: (data: IVolume, original: string) => void):void; };
            /**
            ...
            recommended: {
                ...
                rate: (params: {
                    ...
                    source?: string;
                    volumeId: string;
                }) => { execute(callback: (data: IBooksVolumesRecommendedRateResponse, original: string) => void):void; };
            };
            useruploaded: {
                /**
