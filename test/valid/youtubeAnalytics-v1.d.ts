...
declare module gapi.client {
    ...
    module youtubeAnalytics {
        var batchReportDefinitions: {
            ...
            }) => { execute(callback: (data: IBatchReportDefinitionList, original: string) => void):void; };
        };
        var batchReports: {
            /**
            ...
            list: (params: {
                ...
                onBehalfOfContentOwner: string;
            }) => { execute(callback: (data: IBatchReportList, original: string) => void):void; };
        };
        var reports: {
            /**
             * Retrieve your YouTube Analytics reports.
...
- To request data for a YouTube CMS content owner, set the ids parameter value to contentOwner==OWNER_NAME, where OWNER_NAME is the CMS name of the content owner.
            ...
            query: (params: {
                ...
                "start-date": string;
                "start-index"?: number;
            }) => { execute(callback: (data: IResultTable, original: string) => void):void; };
        };
        /**
