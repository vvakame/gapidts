    ...
    module admin {
        var asps: {
            ...
            get: (params: {
                codeId: number;
                userKey: string;
            }) => { execute(callback: (data: IAsp, original: string) => void):void; };
            /**
            ...
            list: (params: {
                userKey: string;
            }) => { execute(callback: (data: IAsps, original: string) => void):void; };
        };
        var channels: {
            /**
        ...
        var chromeosdevices: {
            ...
            get: (params: {
                ...
                deviceId: string;
                projection?: string;
            }) => { execute(callback: (data: IChromeOsDevice, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                query?: string;
                sortOrder?: string;
            }) => { execute(callback: (data: IChromeOsDevices, original: string) => void):void; };
            /**
        ...
        var groups: {
            ...
            get: (params: {
                groupKey: string;
            }) => { execute(callback: (data: IGroup, original: string) => void):void; };
            /**
             * Create Group
             */
            insert: (params: {
            ...
            aliases: {
                ...
                insert: (params: {
                    groupKey: string;
                    resource?: IAlias;
                }) => { execute(callback: (data: IAlias, original: string) => void):void; };
                /**
                ...
                list: (params: {
                    groupKey: string;
                }) => { execute(callback: (data: IAliases, original: string) => void):void; };
            };
        };
        var members: {
            /**
            ...
            get: (params: {
                groupKey: string;
                memberKey: string;
            }) => { execute(callback: (data: IMember, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                roles?: string;
            }) => { execute(callback: (data: IMembers, original: string) => void):void; };
            /**
        ...
        var mobiledevices: {
            ...
            get: (params: {
                ...
                projection?: string;
                resourceId: string;
            }) => { execute(callback: (data: IMobileDevice, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                query?: string;
                sortOrder?: string;
            }) => { execute(callback: (data: IMobileDevices, original: string) => void):void; };
        };
        var notifications: {
            /**
            ...
            get: (params: {
                customer: string;
                notificationId: string;
            }) => { execute(callback: (data: INotification, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: INotifications, original: string) => void):void; };
            /**
        ...
        var orgunits: {
            ...
            get: (params: {
                customerId: string;
                orgUnitPath: string;
            }) => { execute(callback: (data: IOrgUnit, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                orgUnitPath?: string;
                type?: string;
            }) => { execute(callback: (data: IOrgUnits, original: string) => void):void; };
            /**
        ...
        var tokens: {
            ...
            get: (params: {
                clientId: string;
                userKey: string;
            }) => { execute(callback: (data: IToken, original: string) => void):void; };
            /**
            ...
            list: (params: {
                userKey: string;
            }) => { execute(callback: (data: ITokens, original: string) => void):void; };
        };
        var users: {
            /**
             * Delete user
            ...
            list: (params: {
                ...
                showDeleted?: string;
                sortOrder?: string;
            }) => { execute(callback: (data: IUsers, original: string) => void):void; };
            /**
            ...
            photos: {
                ...
                get: (params: {
                    userKey: string;
                }) => { execute(callback: (data: IUserPhoto, original: string) => void):void; };
                /**
        ...
        var verificationCodes: {
            ...
            list: (params: {
                userKey: string;
            }) => { execute(callback: (data: IVerificationCodes, original: string) => void):void; };
        };
        /**
