    ...
    module bigquery {
        var datasets: {
            ...
            list: (params: {
                ...
                pageToken?: string;
                projectId: string;
            }) => { execute(callback: (data: IDatasetList, original: string) => void):void; };
            /**
        ...
        var jobs: {
            ...
            getQueryResults: (params: {
                ...
                startIndex?: string;
                timeoutMs?: number;
            }) => { execute(callback: (data: IGetQueryResultsResponse, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                projection?: string;
                stateFilter?: string;
            }) => { execute(callback: (data: IJobList, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IQueryResponse, original: string) => void):void; };
        };
        var projects: {
            /**
            ...
            list: (params: {
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: IProjectList, original: string) => void):void; };
        };
        var tabledata: {
            /**
            ...
            }) => { execute(callback: (data: ITableDataInsertAllResponse, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                startIndex?: string;
                tableId: string;
            }) => { execute(callback: (data: ITableDataList, original: string) => void):void; };
        };
        var tables: {
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                projectId: string;
            }) => { execute(callback: (data: ITableList, original: string) => void):void; };
            /**
