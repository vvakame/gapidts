...
declare module gapi.client {
    ...
    module doubleclickbidmanager {
        var lineitems: {
            ...
            }) => { execute(callback: (data: IDownloadLineItemsResponse, original: string) => void):void; };
            /**
             * Uploads line items in CSV format.
             */
            uploadlineitems: (params: {
                resource?: IUploadLineItemsRequest;
            }) => { execute(callback: (data: IUploadLineItemsResponse, original: string) => void):void; };
        };
        var queries: {
            /**
             * Creates a query.
            ...
            createquery: (params: {
                resource?: IQuery;
            }) => { execute(callback: (data: IQuery, original: string) => void):void; };
            /**
             ...
             */
            listqueries: (params: {
            }) => { execute(callback: (data: IListQueriesResponse, original: string) => void):void; };
            /**
        ...
        var reports: {
            ...
            listreports: (params: {
                queryId: string;
            }) => { execute(callback: (data: IListReportsResponse, original: string) => void):void; };
        };
        /**
