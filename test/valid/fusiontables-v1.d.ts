    ...
    module fusiontables {
        var column: {
            ...
            get: (params: {
                columnId: string;
                tableId: string;
            }) => { execute(callback: (data: IColumn, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                tableId: string;
            }) => { execute(callback: (data: IColumnList, original: string) => void):void; };
            /**
        ...
        var query: {
            ...
            sql: (params: {
                ...
                sql: string;
                typed?: boolean;
            }) => { execute(callback: (data: ISqlresponse, original: string) => void):void; };
            /**
        ...
        var style: {
            ...
            get: (params: {
                styleId: number;
                tableId: string;
            }) => { execute(callback: (data: IStyleSetting, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                tableId: string;
            }) => { execute(callback: (data: IStyleSettingList, original: string) => void):void; };
            /**
        ...
        var table: {
            ...
            importRows: (params: {
                ...
                startLine?: number;
                tableId: string;
            }) => { execute(callback: (data: IImport, original: string) => void):void; };
            /**
             * Import a new table.
             * @params {string} delimiter The delimiter used to separate cell values. This can only consist of a single character. Default is ','.
             * @params {string} encoding The encoding of the content. Default is UTF-8. Use 'auto-detect' if you are unsure of the encoding.
        ...
        var template: {
            ...
            get: (params: {
                tableId: string;
                templateId: number;
            }) => { execute(callback: (data: ITemplate, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                tableId: string;
            }) => { execute(callback: (data: ITemplateList, original: string) => void):void; };
            /**
