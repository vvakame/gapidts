    ...
    module manager {
        var deployments: {
            ...
            get: (params: {
                ...
                projectId: string;
                region: string;
            }) => { execute(callback: (data: IDeployment, original: string) => void):void; };
            /**
             * 
             * @params {string} projectId 
             * @params {string} region 
            ...
            list: (params: {
                ...
                projectId: string;
                region: string;
            }) => { execute(callback: (data: IDeploymentsListResponse, original: string) => void):void; };
        };
        var templates: {
            /**
             * 
            ...
            list: (params: {
                ...
                pageToken?: string;
                projectId: string;
            }) => { execute(callback: (data: ITemplatesListResponse, original: string) => void):void; };
        };
        /**
