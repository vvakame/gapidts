 ...
 */
declare module googleapis.plus {
    var activities: {
        /**
         * Get an activity.
    ...
    var moments: {
         ...
         * @params {string} userId The ID of the user to record actions for. The only valid values are "me" and the ID of the authenticated user.
         */
        insert: (params: {
            collection: string;
            debug?: boolean;
