    ...
    module genomics {
        var beacons: {
            ...
            get: (params: {
                ...
                position?: string;
                variantsetId: string;
            }) => { execute(callback: (data: IBeacon, original: string) => void):void; };
        };
        var callsets: {
            /**
            ...
            create: (params: {
                resource?: ICallset;
            }) => { execute(callback: (data: ICallset, original: string) => void):void; };
            /**
             * Deletes a callset.
            ...
            }) => { execute(callback: (data: ISearchCallsetsResponse, original: string) => void):void; };
            /**
             * Updates a callset.
             * @params {string} callsetId The ID of the callset to be updated.
             */
        ...
        var datasets: {
            ...
            create: (params: {
                resource?: IDataset;
            }) => { execute(callback: (data: IDataset, original: string) => void):void; };
            /**
             * Deletes a dataset.
            ...
            list: (params: {
                ...
                pageToken?: string;
                projectId?: string;
            }) => { execute(callback: (data: IListDatasetsResponse, original: string) => void):void; };
            /**
        ...
        var experimental: {
            jobs: {
                ...
                }) => { execute(callback: (data: IExperimentalCreateJobResponse, original: string) => void):void; };
            };
        };
        var jobs: {
            /**
            ...
            get: (params: {
                jobId: string;
            }) => { execute(callback: (data: IJob, original: string) => void):void; };
            /**
             * Gets a list of jobs matching the criteria.
             */
            search: (params: {
                resource?: ISearchJobsRequest;
            }) => { execute(callback: (data: ISearchJobsResponse, original: string) => void):void; };
        };
        var reads: {
            /**
            ...
            }) => { execute(callback: (data: ISearchReadsResponse, original: string) => void):void; };
        };
        var readsets: {
            /**
             * Deletes a readset.
            ...
            }) => { execute(callback: (data: IExportReadsetsResponse, original: string) => void):void; };
            /**
            ...
            get: (params: {
                readsetId: string;
            }) => { execute(callback: (data: IReadset, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IImportReadsetsResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: ISearchReadsetsResponse, original: string) => void):void; };
            /**
             * Updates a readset.
             * @params {string} readsetId The ID of the readset to be updated. The caller must have WRITE permissions to the dataset associated with this readset.
             */
            ...
            coveragebuckets: {
                ...
                }) => { execute(callback: (data: IListCoverageBucketsResponse, original: string) => void):void; };
            };
        };
        var variants: {
            /**
            ...
            create: (params: {
                resource?: IVariant;
            }) => { execute(callback: (data: IVariant, original: string) => void):void; };
            /**
             * Deletes a variant.
            ...
            }) => { execute(callback: (data: IExportVariantsResponse, original: string) => void):void; };
            /**
            ...
            getSummary: (params: {
                variantsetId?: string;
            }) => { execute(callback: (data: IGetVariantsSummaryResponse, original: string) => void):void; };
            /**
             * Creates variant data by asynchronously importing the provided information.
             */
            import: (params: {
                resource?: IImportVariantsRequest;
            }) => { execute(callback: (data: IImportVariantsResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: ISearchVariantsResponse, original: string) => void):void; };
            /**
             * Updates a variant.
             * @params {string} variantId The ID of the variant to be updated..
             */
