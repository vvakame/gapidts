...
declare module gapi.client {
    ...
    module spectrum {
        var paws: {
            ...
            }) => { execute(callback: (data: IPawsGetSpectrumResponse, original: string) => void):void; };
            /**
             * The Google Spectrum Database does not support batch requests, so this method always yields an UNIMPLEMENTED error.
             */
            getSpectrumBatch: (params: {
                resource?: IPawsGetSpectrumBatchRequest;
            }) => { execute(callback: (data: IPawsGetSpectrumBatchResponse, original: string) => void):void; };
            /**
             * Initializes the connection between a white space device and the database.
             */
            init: (params: {
                resource?: IPawsInitRequest;
            }) => { execute(callback: (data: IPawsInitResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IPawsNotifySpectrumUseResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IPawsRegisterResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IPawsVerifyDeviceResponse, original: string) => void):void; };
        };
        /**
