...
declare module gapi.client {
    ...
    module gamesManagement {
        var achievements: {
            ...
            }) => { execute(callback: (data: IAchievementResetResponse, original: string) => void):void; };
            /**
             * Resets all achievements for the currently authenticated player for your application. This method is only accessible to whitelisted tester accounts for your application.
             */
            resetAll: (params: {
            }) => { execute(callback: (data: IAchievementResetAllResponse, original: string) => void):void; };
            /**
        ...
        var applications: {
            ...
            listHidden: (params: {
                ...
                maxResults?: number;
                pageToken?: string;
            }) => { execute(callback: (data: IHiddenPlayerList, original: string) => void):void; };
        };
        var events: {
            /**
        ...
        var scores: {
            ...
            }) => { execute(callback: (data: IPlayerScoreResetResponse, original: string) => void):void; };
            /**
