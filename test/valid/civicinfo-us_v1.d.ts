// Type definitions for Google Google Civic Information API us_v1
...
declare module gapi.client {
    ...
    module civicinfo {
        var divisions: {
            ...
            search: (params: {
                query?: string;
            }) => { execute(callback: (data: IDivisionSearchResponse, original: string) => void):void; };
        };
        var elections: {
            /**
            ...
            }) => { execute(callback: (data: IElectionsQueryResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IVoterInfoResponse, original: string) => void):void; };
        };
        var representatives: {
            /**
            ...
            }) => { execute(callback: (data: IRepresentativeInfoResponse, original: string) => void):void; };
        };
        /**
