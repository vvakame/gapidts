    ...
    module replicapool {
        var pools: {
            ...
            get: (params: {
                ...
                projectName: string;
                zone: string;
            }) => { execute(callback: (data: IPool, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                projectName: string;
                zone: string;
            }) => { execute(callback: (data: IPoolsListResponse, original: string) => void):void; };
            /**
        ...
        var replicas: {
            ...
            }) => { execute(callback: (data: IReplica, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                projectName: string;
                zone: string;
            }) => { execute(callback: (data: IReplicasListResponse, original: string) => void):void; };
            /**
