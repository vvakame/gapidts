    ...
    module appstate {
        var states: {
            ...
            clear: (params: {
                ...
                stateKey: number;
            }) => { execute(callback: (data: IWriteResult, original: string) => void):void; };
            /**
            ...
            get: (params: {
                stateKey: number;
            }) => { execute(callback: (data: IGetResponse, original: string) => void):void; };
            /**
            ...
            list: (params: {
                includeData?: boolean;
            }) => { execute(callback: (data: IListResponse, original: string) => void):void; };
            /**
