...
declare module gapi.client {
    ...
    module mirror {
        ...
        var contacts: {
            ...
            get: (params: {
                id: string;
            }) => { execute(callback: (data: IContact, original: string) => void):void; };
            /**
             ...
             */
            list: (params: {
            }) => { execute(callback: (data: IContactsListResponse, original: string) => void):void; };
            /**
        ...
        var locations: {
            ...
            get: (params: {
                id: string;
            }) => { execute(callback: (data: ILocation, original: string) => void):void; };
            /**
             * Retrieves a list of locations for the user.
             */
            list: (params: {
            }) => { execute(callback: (data: ILocationsListResponse, original: string) => void):void; };
        };
        var settings: {
            /**
...
- timezone - The key to the user’s current time zone region as defined in the tz database. Example: America/Los_Angeles.
        ...
        var subscriptions: {
             ...
             */
            list: (params: {
            }) => { execute(callback: (data: ISubscriptionsListResponse, original: string) => void):void; };
            /**
        ...
        var timeline: {
            ...
            get: (params: {
                id: string;
            }) => { execute(callback: (data: ITimelineItem, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pinnedOnly?: boolean;
                sourceItemId?: string;
            }) => { execute(callback: (data: ITimelineListResponse, original: string) => void):void; };
            /**
            ...
            attachments: {
                ...
                get: (params: {
                    attachmentId: string;
                    itemId: string;
                }) => { execute(callback: (data: IAttachment, original: string) => void):void; };
                /**
                ...
                list: (params: {
                    itemId: string;
                }) => { execute(callback: (data: IAttachmentsListResponse, original: string) => void):void; };
            };
        };
        /**
