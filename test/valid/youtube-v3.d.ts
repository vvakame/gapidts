...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a activity resource, the snippet property contains other properties that identify the type of activity, a display title for the activity, and so forth. If you set part=snippet, the API response will also contain all of those nested properties.
            ...
            list: (params: {
                ...
                regionCode?: string;
            }) => { execute(callback: (data: IActivityListResponse, original: string) => void):void; };
        };
        var channelBanners: {
            /**
...
The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user authenticates with must be linked to the specified YouTube content owner.
            ...
            }) => { execute(callback: (data: IChannelBannerResource, original: string) => void):void; };
        };
        var channelSections: {
            /**
...
The part names that you can include in the parameter value are snippet and contentDetails.
            ...
            }) => { execute(callback: (data: IChannelSection, original: string) => void):void; };
            /**
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a channelSection resource, the snippet property contains other properties, such as a display title for the channelSection. If you set part=snippet, the API response will also contain all of those nested properties.
            ...
            list: (params: {
                ...
                onBehalfOfContentOwner?: string;
                part: string;
            }) => { execute(callback: (data: IChannelSectionListResponse, original: string) => void):void; };
            /**
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a channel resource, the contentDetails property contains other properties, such as the uploads properties. As such, if you set part=contentDetails, the API response will also contain all of those nested properties.
            ...
            list: (params: {
                ...
                pageToken?: string;
                part: string;
            }) => { execute(callback: (data: IChannelListResponse, original: string) => void):void; };
            /**
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a guideCategory resource, the snippet property contains other properties, such as the category's title. If you set part=snippet, the API response will also contain all of those nested properties.
            ...
            list: (params: {
                ...
                part: string;
                regionCode?: string;
            }) => { execute(callback: (data: IGuideCategoryListResponse, original: string) => void):void; };
        };
        var i18nLanguages: {
            /**
            ...
            list: (params: {
                hl?: string;
                part: string;
            }) => { execute(callback: (data: II18nLanguageListResponse, original: string) => void):void; };
        };
        var i18nRegions: {
            /**
            ...
            list: (params: {
                hl?: string;
                part: string;
            }) => { execute(callback: (data: II18nRegionListResponse, original: string) => void):void; };
        };
        var liveBroadcasts: {
            /**
...
This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
            ...
            bind: (params: {
                ...
                part: string;
                streamId?: string;
            }) => { execute(callback: (data: ILiveBroadcast, original: string) => void):void; };
            /**
...
This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
            ...
            list: (params: {
                ...
                pageToken?: string;
                part: string;
            }) => { execute(callback: (data: ILiveBroadcastListResponse, original: string) => void):void; };
            /**
...
The part properties that you can include in the parameter value are id, snippet, cdn, and status.
            ...
            }) => { execute(callback: (data: ILiveStream, original: string) => void):void; };
            /**
...
This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
            ...
            list: (params: {
                ...
                pageToken?: string;
                part: string;
            }) => { execute(callback: (data: ILiveStreamListResponse, original: string) => void):void; };
            /**
...
The part names that you can include in the parameter value are snippet, contentDetails, and status.
            ...
            }) => { execute(callback: (data: IPlaylistItem, original: string) => void):void; };
            /**
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a playlistItem resource, the snippet property contains numerous fields, including the title, description, position, and resourceId properties. As such, if you set part=snippet, the API response will contain all of those properties.
            ...
            list: (params: {
                ...
                playlistId?: string;
                videoId?: string;
            }) => { execute(callback: (data: IPlaylistItemListResponse, original: string) => void):void; };
            /**
...
The part names that you can include in the parameter value are snippet and status.
            ...
            insert: (params: {
                ...
                part: string;
                resource?: IPlaylist;
            }) => { execute(callback: (data: IPlaylist, original: string) => void):void; };
            /**
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a playlist resource, the snippet property contains properties like author, title, description, tags, and timeCreated. As such, if you set part=snippet, the API response will contain all of those properties.
            ...
            list: (params: {
                ...
                pageToken?: string;
                part: string;
            }) => { execute(callback: (data: IPlaylistListResponse, original: string) => void):void; };
            /**
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a search result, the snippet property contains other properties that identify the result's title, description, and so forth. If you set part=snippet, the API response will also contain all of those nested properties.
            ...
            list: (params: {
                ...
                videoType?: string;
            }) => { execute(callback: (data: ISearchListResponse, original: string) => void):void; };
        };
        var subscriptions: {
            /**
...
The part names that you can include in the parameter value are snippet and contentDetails.
            ...
            }) => { execute(callback: (data: ISubscription, original: string) => void):void; };
            /**
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a subscription resource, the snippet property contains other properties, such as a display title for the subscription. If you set part=snippet, the API response will also contain all of those nested properties.
            ...
            list: (params: {
                ...
                pageToken?: string;
                part: string;
            }) => { execute(callback: (data: ISubscriptionListResponse, original: string) => void):void; };
        };
        var thumbnails: {
            /**
            ...
            set: (params: {
                onBehalfOfContentOwner?: string;
                videoId: string;
            }) => { execute(callback: (data: IThumbnailSetResponse, original: string) => void):void; };
        };
        var videoCategories: {
            /**
            ...
            list: (params: {
                ...
                part: string;
                regionCode?: string;
            }) => { execute(callback: (data: IVideoCategoryListResponse, original: string) => void):void; };
        };
        var videos: {
            /**
...
The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user authenticates with must be linked to the specified YouTube content owner.
            ...
            getRating: (params: {
                id: string;
                onBehalfOfContentOwner?: string;
            }) => { execute(callback: (data: IVideoGetRatingResponse, original: string) => void):void; };
            /**
...
The part names that you can include in the parameter value are snippet, contentDetails, fileDetails, liveStreamingDetails, player, processingDetails, recordingDetails, statistics, status, suggestions, and topicDetails. However, not all of those parts contain properties that can be set when setting or updating a video's metadata. For example, the statistics object encapsulates statistics that YouTube calculates for a video and does not contain values that you can set or modify. If the parameter value specifies a part that does not contain mutable values, that part will still be included in the API response.
            ...
            insert: (params: {
                ...
                stabilize?: boolean;
                resource?: IVideo;
            }) => { execute(callback: (data: IVideo, original: string) => void):void; };
            /**
...
If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a video resource, the snippet property contains the channelId, title, description, tags, and categoryId properties. As such, if you set part=snippet, the API response will contain all of those properties.
            ...
            list: (params: {
                ...
                regionCode?: string;
                videoCategoryId?: string;
            }) => { execute(callback: (data: IVideoListResponse, original: string) => void):void; };
            /**
