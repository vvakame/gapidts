    ...
    module pubsub {
        var subscriptions: {
            ...
            list: (params: {
                ...
                pageToken?: string;
                query?: string;
            }) => { execute(callback: (data: IListSubscriptionsResponse, original: string) => void):void; };
            /**
            ...
            }) => { execute(callback: (data: IPullResponse, original: string) => void):void; };
        };
        var topics: {
            /**
            ...
            create: (params: {
                resource?: ITopic;
            }) => { execute(callback: (data: ITopic, original: string) => void):void; };
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                query?: string;
            }) => { execute(callback: (data: IListTopicsResponse, original: string) => void):void; };
            /**
