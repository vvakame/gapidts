...
declare module gapi.client {
    ...
    module coordinate {
        var customFieldDef: {
            ...
            list: (params: {
                teamId: string;
            }) => { execute(callback: (data: ICustomFieldDefListResponse, original: string) => void):void; };
        };
        var jobs: {
            /**
            ...
            list: (params: {
                ...
                pageToken?: string;
                teamId: string;
            }) => { execute(callback: (data: IJobListResponse, original: string) => void):void; };
            /**
        ...
        var location: {
            ...
            list: (params: {
                ...
                teamId: string;
                workerEmail: string;
            }) => { execute(callback: (data: ILocationListResponse, original: string) => void):void; };
        };
        var schedule: {
            /**
            ...
            get: (params: {
                jobId: string;
                teamId: string;
            }) => { execute(callback: (data: ISchedule, original: string) => void):void; };
            /**
        ...
        var worker: {
            ...
            list: (params: {
                teamId: string;
            }) => { execute(callback: (data: IWorkerListResponse, original: string) => void):void; };
        };
        /**
         * Custom field.
         */
