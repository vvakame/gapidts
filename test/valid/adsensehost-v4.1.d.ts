    ...
    module adsensehost {
        var accounts: {
            ...
            adclients: {
                ...
                get: (params: {
                    accountId: string;
                    adClientId: string;
                }) => { execute(callback: (data: IAdClient, original: string) => void):void; };
                /**
        ...
        var associationsessions: {
            ...
            start: (params: {
                ...
                websiteUrl: string;
            }) => { execute(callback: (data: IAssociationSession, original: string) => void):void; };
            /**
        ...
        var urlchannels: {
            ...
            delete: (params: {
                adClientId: string;
                urlChannelId: string;
            }) => { execute(callback: (data: IUrlChannel, original: string) => void):void; };
            /**
